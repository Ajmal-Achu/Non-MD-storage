...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'zavatar2 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://api.lolhuman.xyz/api/ephoto1/avatarlolnew?apikey=${Config.LOLUHUMAN_API}&text=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
