...
if (Config.WORKTYPE == 'private') {
  ...
  Raashii.addCommand({ pattern: 'spdf ?(.*)', fromMe: true, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(rashi.data), MessageType.document, { filename: 'sophia.pdf', mimetype: Mimetype.pdf});
  ...
  Raashii.addCommand({ pattern: 'spdf ?(.*)', fromMe: false, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(rashi.data), MessageType.document, {quoted: message.data, filename: 'sophia.pdf', mimetype: Mimetype.pdf});
