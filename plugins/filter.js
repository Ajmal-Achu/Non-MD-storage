...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Hisham.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted : message.data, ptt: true})
        }
